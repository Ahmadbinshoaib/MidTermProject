 ...
 * @author Maria
 */
public class AccessoryLogIn extends javax.swing.JFrame {
  Manager b= Manager.getInstance();
    /**
     * Creates new form AccessoryLogIn
     */
    public AccessoryLogIn() {
        initComponents();
    }
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
       ...
       String p= pass.getText();
        ...
        if(u.equals(b.getUsername()) && p.equals(b.getPassword()))
      {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccessoryLogIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccessoryLogIn().setVisible(true);
            }
        });
    }
